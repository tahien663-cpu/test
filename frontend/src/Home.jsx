        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-40 transition-opacity duration-300 px-4">
          <div className={`backdrop-blur-2xl rounded-3xl p-6 sm:p-8 max-w-lg w-full transform transition-all duration-300 scale-95 animate-[modalIn_0.3s_ease-out_forwards] ${theme === 'light' ? 'bg-gray-800/90' : 'bg-white/[0.08]'}`}>
            ...
            <button
              ...
              className={`mt-6 w-full px-4 py-2 rounded-xl transition-all duration-200 hover:scale-105 font-semibold ${theme === 'light' ? 'bg-blue-700 text-white hover:bg-blue-800' : 'bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:shadow-purple-500/20'}`}
            >
              Đóng
            </button>
          </div>
